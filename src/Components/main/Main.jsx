        ...
        <div className="p3">
          <div className="p5">
            ...
            <div className={isOn ? "icns" : "icons"}>
              <a href="https://www.linkedin.com/in/sai-s12/" style={{color:"white"}}> <BsLinkedin /></a>
              <a href="https://github.com/SAI-S12"> <BsGithub /></a>
              <a href=""><BsYoutube /></a>
            </div>
            <button className={isOn ? "p9" : "p99"}><a href={resume} download="resume" style={{color:isOn?'black':"white"}}>Download cv</a></button>
          </div>
        </div>
        <div className="p4">
